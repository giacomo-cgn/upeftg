...
RUN_ID=${RUN_ID:-few_shot_cnn_insertsent}
MANIFEST_JSON=${MANIFEST_JSON:-${REPO_ROOT}/manifests/few_shot/few_shot_knn_insertsent_data.json}
FEATURE_FILE=${FEATURE_FILE:-${REPO_ROOT}/runs/feature_extract/list2_features-merged-cnn/merged/spectral_features.npy}
FEW_SHOT_HYPERPARAMS=${FEW_SHOT_HYPERPARAMS:-${REPO_ROOT}/manifests/few_shot/few_shot_knn_insertsent_hyperparams.json}
FEATURES=(
  energy
  kurtosis
  l1_norm
