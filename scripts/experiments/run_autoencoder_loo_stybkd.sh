...
RUN_ID=${RUN_ID:-autoencoder_loo_stybkd}
MANIFEST_JSON=${MANIFEST_JSON:-${REPO_ROOT}/manifests/selfsupervised_hyperparams/autoencoder_loo/ag_news_imdb_loo_stybkd.json}
