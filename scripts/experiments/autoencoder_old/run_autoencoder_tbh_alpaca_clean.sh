...
RUN_ID=${RUN_ID:-autoencoder_tbh_alpaca_clean}
MANIFEST_JSON=${MANIFEST_JSON:-${REPO_ROOT}/manifests/selfsupervised_hyperparams/llama2_7b_toxic_backdoors_alpaca_clean.json}
FEATURE_FILE=${FEATURE_FILE:-${REPO_ROOT}/runs/feature_extract/list2_features-merged-cnn/merged/spectral_features.npy}
AUTOENCODER_HYPERPARAMS=${AUTOENCODER_HYPERPARAMS:-${REPO_ROOT}/manifests/selfsupervised_hyperparams/autoencoder_hyperparams_clean.json}
